// Identidad de cada país destino. `currency` es el código ISO usado para
// buscar su tasa (en vivo o de respaldo) en src/lib/rates.ts — las tasas
// viven aparte porque cambian con el tiempo, esto no.
